...
import { Watch, Phone as IPhone, Tablet as IPad, Headphones as Airpods } from "lucide-react";
      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto">
            Trabalhamos com preços oficiais, menor valor do mercado e cobrimos qualquer oferta. Confira nossas categorias e escolha seu produto Apple!
          </p>
        </div>
          ...
          <div className="flex justify-center mb-8">
            <TabsList>
              <TabsTrigger value="iphones" className="flex items-center gap-2">
                ...
                <span className={isMobile ? "inline" : "hidden sm:inline"}>iPhones</span>
              </TabsTrigger>
              <TabsTrigger value="watches" className="flex items-center gap-2">
                <Watch className="h-4 w-4" />
                <span className={isMobile ? "inline" : "hidden sm:inline"}>Apple Watch</span>
              </TabsTrigger>
              <TabsTrigger value="airpods" className="flex items-center gap-2">
                <Airpods className="h-4 w-4" />
                <span className={isMobile ? "inline" : "hidden sm:inline"}>AirPods</span>
              </TabsTrigger>
              <TabsTrigger value="ipads" className="flex items-center gap-2">
                <IPad className="h-4 w-4" />
                <span className={isMobile ? "inline" : "hidden sm:inline"}>iPads</span>
              </TabsTrigger>
            </TabsList>
          </div>
